...
SECRET_KEY = 'django-insecure-uf@%wlrmx2-4s#)j3)r$2b9exl^fmg+2wq7-q9l9h%l$pd%5f7'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Directory for additional static files (like your custom CSS, JS)
]
